        ...
        (async function() {
          try {
            ...
            const response = await fetch('http://localhost:5001/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '00cfdf04-241f-4c53-a495-70fedb85922f',
                name: data.name || '',
                email: data.email || '',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Fitness With Galit משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
